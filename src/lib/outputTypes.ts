...
`,
  },
  {
    id: 'trait-summary',
    name: 'AI向け自分データ',
    description: '特徴を整理したテキストを生成。他のAIに渡して活用できる',
    minLength: 200,
    maxLength: 800,
    icon: '📋',
    enabled: true,
    recommendedModes: ['basic', 'manual', 'self-pr'],
    systemPrompt: `
以下のユーザー特徴データを元に、他のAIサービスに渡して活用できる「自分データシート」を作成してください。

【目的】
このテキストを他のAIに渡すことで、ユーザーに合った商品を探してもらったり、
自分にぴったりな話し相手を作ったり、パーソナライズされた提案を受けることができます。

【条件】
- 200〜800文字程度
- カテゴリごとに整理（性格・価値観、スキル・得意なこと、興味・関心、ライフスタイル など）
- 箇条書きで簡潔に、でも具体的に
- AIが解釈しやすいよう、曖昧な表現を避けて明確に書く
- 絵文字は使わない
- 敬語不要、事実ベースで記述
...
【注意】
- 該当する特徴がないカテゴリは省略してOK
- ユーザーの特徴データに忠実に、誇張や推測をしない
- 上記フォーマットのテキストのみを出力。説明や注釈は不要
`,
  },
  {
    id: 'career-match',
  ...
  },
  {
    id: 'story',
    name: 'じぶん物語',
    description: '特徴データからあなたが主人公の5話完結の物語を生成',
    minLength: 0,
    maxLength: 0,
    icon: '📖',
    enabled: true,
