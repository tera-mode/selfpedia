...
AIとの会話で自分の特徴を集めて図鑑を作る。自己PR・プロフィール等のアウトプットを自動生成するサービス
...
| サービス名 | じぶん図鑑 |
| ドメイン | selfpedia.jp |
| コンセプト | AIとの会話で自分の特徴を集めて図鑑を作る。自己PR・プロフィール等のアウトプットを自動生成 |
...
| ID | モード名 | アイコン | 質問数 | 説明 |
|----|----------|---------|--------|------|
| basic | 基本インタビュー | 💬 | エンドレス | 多角的にあなたを深掘りし、様々な魅力を発見します |
| self-pr | 自己PR発見 | 💼 | 10問 | 仕事での強みや成果にフォーカスし、自己PRを作成します |
| manual | わたしの取説 | 📖 | 10問 | コミュニケーションスタイルや好き嫌いを明確にします |

**エンドレスモード（basic）**:
- 終了ボタンでいつでもインタビューを完了可能
- 途中でブラウザを閉じても、それまでの特徴は保存される

**固定質問数モード（self-pr, manual）**:
- 決まった質問数でインタビューが完了
- 目的に特化した質問で効率的に情報を引き出す
